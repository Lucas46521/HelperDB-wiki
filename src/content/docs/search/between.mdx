---
title: Método between()
description: Busca valores numéricos entre um valor mínimo e máximo, com suporte a filtros e paginação.
---

---
title: between
description: Busca valores dentro de um intervalo específico
---
